...
namespace TaskAgendaProj.Validators
{
    ...
    {
        ErrorsCollection Validate(RegisterPostModel registerPostModel, TasksDbContext context);
    }

    public class RegisterValidator : IRegisterValidator
    {
        public ErrorsCollection Validate(RegisterPostModel registerPostModel, TasksDbContext context)
        {
