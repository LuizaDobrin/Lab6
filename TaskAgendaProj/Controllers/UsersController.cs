...
namespace TaskAgendaProj.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IUsersService userService, IUserUserRoleService userUserRolesService)
        {
        ...
        public IActionResult Post([FromBody] UserUserRolePostModel userUserRolePostModel)        //pentru creare de UserUserRole cu legatura manytomany intre User si UserRole
        {
            ...
            {
                var anulUserRegistered = curentUserLogIn.DateAdded;        //data inregistrarii
