    ...
    public class UsersServiceTests
    {
        ...
        public void AuthenticateShouldLogTheRegisteredUser()
        {
            ...
            using (var context = new TasksDbContext(options))
            {
                ...
                var authenticated = new TaskAgendaProj.ViewModels.LoginPostModel
                {
                    Username = "test_userName1",
                    Password = "111111"
                };
        ...
        public void GetAllShouldReturnAllRegisteredUsers()
        {
            ...
            using (var context = new TasksDbContext(options))
            {
                ...
                var added2 = new TaskAgendaProj.ViewModels.RegisterPostModel
                {
        ...
        public void UpsertShouldModifyFildsValues()
        {
            ...
            using (var context = new TasksDbContext(options))
            {
                var validator = new RegisterValidator();
                var usersService = new UsersService(context, validator, null, config);
                var added22 = new TaskAgendaProj.ViewModels.RegisterPostModel
                {
                    FirstName = "Nume",
                    LastName = "Prenume",
                    UserName = "userName",
                ...
                var updated = new TaskAgendaProj.ViewModels.UserPostModel
                {
                    FirstName = "Alin",
                    LastName = "Popescu",
                    UserName = "popAlin",
